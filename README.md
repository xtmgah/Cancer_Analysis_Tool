...
Using the scripts in this tool, you can visualize the 3-mer mutational signatures which results in a gplots like this:

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM5NDc2OTUxMiwxNDg1MzkxMTgyXX0=
-->